...
<head>
	...
	<link rel="stylesheet" id="wp-block-library-css"
		href="<?php echo get_template_directory_uri(); ?>/assets/css/bootstrap.min.css" type="text/css" media="all" />
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-item">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/SVG/cross.svg" alt="" />
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
						<div class="icon-item">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/img/SVG/check-mark.svg" alt="" />
